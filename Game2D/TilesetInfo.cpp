...
std::unordered_map<glm::ivec2, TileInfo> TilesetInfo::get() {
	return {
		...
		/*{ glm::ivec2(5, 3), TileInfo{.isSolid = true } },
		{ glm::ivec2(6, 3), TileInfo{.isSolid = true } },
		{ glm::ivec2(7, 3), TileInfo{.isSolid = true } },*/

		/*{ glm::ivec2(0, 4), TileInfo{.isSolid = true } },
		{ glm::ivec2(1, 4), TileInfo{.isSolid = true } },
		{ glm::ivec2(2, 4), TileInfo{.isSolid = true } },
		{ glm::ivec2(3, 4), TileInfo{.isSolid = true } },
		{ glm::ivec2(4, 4), TileInfo{.isSolid = true } },
		{ glm::ivec2(5, 4), TileInfo{.isSolid = true } },
		{ glm::ivec2(6, 4), TileInfo{.isSolid = true } },
		{ glm::ivec2(7, 4), TileInfo{.isSolid = true } },
